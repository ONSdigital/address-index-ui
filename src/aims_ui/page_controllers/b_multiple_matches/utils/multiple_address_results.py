...
def format_single_job(job_data):
  ...
  single_job_data['recssofarmessage'] = get_recs_so_far_message(single_job_data)
  single_job_data['downloadlink'] = job_result_formatter(single_job_data.get('jobid'))
  ...
  if dataset:
    ...
    single_job_data['header_row_export'] = get_friendly_header_row_export(ui_metadata)
  else:
    ...
    try:
      ...
      single_job_data['header_row_export'] = get_friendly_header_row_export(ui_metadata_old)
