...
additional_usernames = [{ 'name_of_group': 'default', 'usernames': ['testDefaultExplicit'] },
                        { 'name_of_group': 'developers', 'usernames': ['testDeveloperExplicit'] },
                        { 'name_of_group': 'bulk_removed', 'usernames': ['testBulkRemovedExplicit'] },
                        { 'name_of_group': 'limited_bulk', 'usernames': ['testBulkLimitedExplicit'] },
                        ]
