...
def get_fields(endpoint_name, include_UPRN_redirect=False):
  ...
  if endpoint_name == 'uprn':
    ...
    return ([
        ...
        common_fields['northern_ireland_boost_checkbox'],
        common_fields['channel_islands_boost_checkbox'],
        common_fields['isle_of_man_boost_checkbox'],
        common_fields['offshore_boost_checkbox'],
        common_fields['epoch'],
        common_fields['historical'],
