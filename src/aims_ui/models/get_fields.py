  ...
  if endpoint_name == 'uprn':
    ...
    return ([
      ...
      Field('favourwelsh',
        ...
        description='If you prefer the results to be flavoured Welsh tick this box',), 
      Field('groupfullpostcodes',
        search_type='checkbox',
        display_title='Group full postcodes',
        description='If you bwould like the results to be grouped by their respective full postcodes, tick this box',), 
      Field('fallback',
        search_type='checkbox',
    ...
    return ([
      Field('postcode',
        ...
        classes='input--w-8',
        required = True,
        description='A postcode is a code for post which separates houses into groups. This is often a 7 didgit letter and number combo.'),
      common_fields['limit'],
      common_fields['classification'],
      common_fields['epoch'],
      common_fields['england_boost'],
