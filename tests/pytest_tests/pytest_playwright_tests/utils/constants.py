...
# Files generated by JS during runtime, but have consistant content
DYNAMIC_FILES = [
    {
     'download_name': 'Attribute Descriptions',
     'description': 'A list of all attributes with descriptions, available on the address_info page',
     'file_name': 'address_attributes.txt',
     'expected_content': None,
     },
]

JS_DOWNLOADS = build_js_downloads(DYNAMIC_FILES)
