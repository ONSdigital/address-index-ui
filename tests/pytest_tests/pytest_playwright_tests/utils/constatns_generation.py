...
def build_js_downloads(DYNAMIC_FILES):
  """ Build the JS_DOWNLOADS global dict, which contains info on files that are generated by JS during runtime, but have consistant content """
  for file in DYNAMIC_FILES:
    expected_content = get_content_of_file(file.get('file_name'))
    file['expected_content'] = expected_content
