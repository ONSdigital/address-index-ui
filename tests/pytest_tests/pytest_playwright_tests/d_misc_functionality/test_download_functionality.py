...
def test_static_file(page: Page, download_info):
  ...
  print(f'Expected Content: {type(expected_file_content)}, {expected_file_content}, {len(expected_file_content)}')
  print(f'Actual Content: {type(actual_content)}, {actual_content}, {len(actual_content)}')
